...
```{r dfle_table02, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r dfle_figure01, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r dfle_figure02, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r dfle_figure03_suppl_material, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r dfle_figure04_suppl_material, echo=FALSE, message=FALSE, warning=FALSE}
